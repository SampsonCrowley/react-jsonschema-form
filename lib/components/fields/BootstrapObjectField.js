...
var BootstrapObjectField = function (_Component) {
  _inherits(BootstrapObjectField, _Component);

  function BootstrapObjectField() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, BootstrapObjectField);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BootstrapObjectField.__proto__ || Object.getPrototypeOf(BootstrapObjectField)).call.apply(_ref, [this].concat(args))), _this), _this.onPropertyChange = function (name) {
  ...
  _createClass(BootstrapObjectField, [{
    key: "isRequired",
        ...
        _react2.default.createElement(
          ...
          orderedProperties.map(function (name, index) {
            ...
            if (!/col\-xs\-.*/.test(uiSchema[name]["classNames"])) {
              uiSchema[name]["classNames"] = (uiSchema[name]["classNames"] || "") + " col-xs-12";
            }
  ...
  return BootstrapObjectField;
}(_react.Component);

BootstrapObjectField.defaultProps = {
  uiSchema: {},
  formData: {},
  errorSchema: {},
  idSchema: {},
...
exports.default = BootstrapObjectField;